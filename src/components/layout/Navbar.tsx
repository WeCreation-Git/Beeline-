        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#map" className="hover:text-yellow-400 transition-colors duration-300">Map</a>
              <a href="#contact" className="hover:text-yellow-400 transition-colors duration-300">Contact Us</a>
              <a href="#booking" className="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded-lg transition-colors duration-300">Booking</a>
            </div>
          </div>
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-900 rounded-lg mt-2">
              ...
              <a href="#map" className="block px-3 py-2 hover:text-yellow-400 transition-colors duration-300">Map</a>
              <a href="#contact" className="block px-3 py-2 hover:text-yellow-400 transition-colors duration-300">Contact Us</a>
              <a href="#booking" className="block px-3 py-2 bg-yellow-500 hover:bg-yellow-600 text-black rounded-lg transition-colors duration-300">Booking</a>
