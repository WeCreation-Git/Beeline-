...
const InstagramReels = () => {
  const reels = [
    ...
    },
    {
      id: 2,
      videoUrl: "/video2.mp4",
      linkUrl: "https://www.instagram.com/reel/C2345678901/",
      title: "Interior Deep Clean Results"
    },
    {
      id: 3,
      videoUrl: "/video3.mp4",
      linkUrl: "https://www.instagram.com/reel/C3456789012/",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reels.map((reel, index) => (
            ...
            >
              <div className="relative aspect-[9/16] max-h-96 group cursor-pointer" onClick={() => window.open(reel.linkUrl, '_blank')}>
                <video
                  src={reel.videoUrl}
